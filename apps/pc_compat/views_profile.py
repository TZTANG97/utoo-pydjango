...
def _forward_or_local(request: Request, auth_path: str, local_fn):
    if svc_auth_enabled():
        return forward_auth(request, auth_path)
    return local_fn()
...
def update_user_basic_info(request: Request):
    ...
    return _forward_or_local(request, "/api/auth/update-basic-info", _local)
...
def set_password(request: Request):
    ...
    return _forward_or_local(request, "/api/auth/set-password", _local)
...
def update_phone_avatar(request: Request):
    ...
    return _forward_or_local(request, "/api/auth/upload-avatar", _local)
...
def add_or_update_user_data(request: Request):
    ...
    return _forward_or_local(request, "/api/auth/update-personal-profile", _local)
...
def add_or_update_user_company_data(request: Request):
    ...
    return _forward_or_local(request, "/api/auth/update-company-profile", _local)
