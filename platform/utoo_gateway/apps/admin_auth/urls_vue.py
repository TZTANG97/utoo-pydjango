...
urlpatterns = [
    ...
    path("invoice/openPreview.ajax", views_billing.invoice_open_preview, name="admin-invoice-open-preview"),
    path("invoice/agreeInvoice.ajax", views_billing.invoice_agree, name="admin-invoice-agree"),
    path("bill/addBillDataInvoice.ajax", views_billing.invoice_agree, name="admin-invoice-agree-bill"),
