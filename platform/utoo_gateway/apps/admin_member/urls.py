...
from apps.admin_member.views import member_account as member_account_views
from apps.admin_member.views import offline_recharge as recharge_views

urlpatterns = [
    # 会员账号（userType=5，对齐 Java member/memberList.ajax）
    path("memberAccount/list.ajax", member_account_views.account_list),
    path("memberAccount/get.ajax", member_account_views.account_get),
    path("memberAccount/save.ajax", member_account_views.account_save),
    path("memberAccount/updateStatus.ajax", member_account_views.account_update_status),
    path("memberAccount/validUserName.ajax", member_account_views.account_valid_username),
    # 个人会员
