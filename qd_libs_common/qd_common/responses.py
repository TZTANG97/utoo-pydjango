"""
统一 API 响应。对齐 docs/前后端接口迁移.md 与 Django apps.core.responses。
"""
...
def ajax_ok(obj: Any = None, res_msg: str = "操作成功") -> dict:
    """Java 兼容：res=1, resMsg, obj"""
    return {"res": 1, "resMsg": res_msg, "obj": obj}


def ajax_fail(res_msg: str = "操作失败", obj: Any = None) -> dict:
