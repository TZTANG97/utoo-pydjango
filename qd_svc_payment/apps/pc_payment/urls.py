...
urlpatterns = [
    ...
    path("selRechargeStatus.ajax", views_pay.sel_recharge_status_view),
    path("selRechargeList.ajax", views_pay.sel_recharge_list_view),
    path("selDefaultAccount.ajax", views_pay.sel_default_account_view),
