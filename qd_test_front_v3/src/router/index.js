...
export const constantRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'cateDetail',
        name: 'CateDetail',
        component: () => import('@/views/cateDetail/index'),
        meta: { title: '分类详情' }
      },
      {
        path: 'discussion',
...

      {
        ...
        hidden: true,
        meta: {title: '讨论详情'},
        component: () => import('@/views/discussion/detail')
      },
    ]
  },
  {
    ...
    hidden: true,
    meta: {title: '查看预约单'},
    component: () => import('@/views/make/index')
  },
  {
    path: '/companyInt',
    name: 'CompanyInt',
    hidden: true,
    meta: {title: '公司介绍'},
    component: () => import('@/views/companyInt/index')
  },
  // {
  //   path: '/b',
  //   component: Layout,
  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'OrderDetail2',
        component: () => import('@/views/orderDetail2/index'),
        hidden: true,
        meta: { title: '兑换详情' }
      },
      {
        ...
        component: () => import('@/views/childOrderDetail/index'),
        hidden: true,
        meta: { title: '子订单详情' }
      },
    ]
  ...
  },
  {
    ...
    children: [{
      path: '',
      name: 'Sub',
      component: () => import('@/views/sub/index'),
  ...
  },
  {
    ...
    children: [{
      path: '',
      name: 'SubDetail',
      component: () => import('@/views/sub_detail/index'),
      meta: { title: '预约详情' },
    }]
  },
  {
  ...
  },
  {
    ...
    children: [{
      path: '',
      name: 'payHistory',
      component: () => import('@/views/payHistory/index'),
      meta: {title: '流水明细'},
    }]
  },
  {
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/makeInvoiceDetail/index'),
      meta: { title: '开票详情' },
    }]
  },
  {
    ...
    children: [{
      path: '',
      name: 'payDetail',
      component: () => import('@/views/payDetail/index'),
      meta: { title: '充值详情' },
    }]
  },
  {
    ...
    children: [{
      path: '',
      name: 'paymentDetail',
      component: () => import('@/views/paymentDetail/index'),
      meta: { title: '支付详情' },
    }]
  },
  {
    ...
    children: [{
      path: '',
      name: 'paymentDetail',
      component: () => import('@/views/discussionNotes/index'),
    ...
    children: [
      {
        ...
        hidden: true,
        component: () => import('@/views/discussionNotes/issue'),
        meta: {title: '发布'}
      }
    ]
  },
