    ...
    <div class="comments-list">
      ...
      >
        ...
        <div class="comment-actions">
          ...
          >
            <img class="menu-icon" src="@/static/zan.png" v-if="comment.isLike != 1" />
            <img class="menu-icon" src="@/static/zan1.png" v-if="comment.isLike == 1"/>
              ...
              <div class="reply-content">
                ...
                <div class="reply-actions">
                  ...
                  <button class="reply-like-btn" @click="handleReplyLike(commentIndex, replyIndex)">
                    <img class="menu-icon" src="@/static/zan.png" v-if="reply.isLike != 1" />
                    <img class="menu-icon" src="@/static/zan1.png" v-if="reply.isLike == 1"/>
...
import {commentLike, deletecomment, deleteentry, insertcomment} from "@/api/discussion"
import { buildOssImageUrl, defaultAvatarUrl } from "@/utils/oss-image"
