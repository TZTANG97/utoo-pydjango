...
import CommentSection from "@/views/discussion/comments/CommentSection.vue";
import {entryDetail, entryMenu} from "@/api/discussion";
import TextTruncation from "@/views/discussion/components/textTruncation.vue";
import Carousel from "@/views/discussion/comments/Carousel.vue";
export default {
  components: {
    Carousel,
    TextTruncation,
...
<!--          <el-button  size="medium" class="el-icon-edit item_btn">写回答</el-button>-->
          ...
          <div class="item_btn" @click="menuType(2)">
            <img class="menu-icon" src="@/static/love.png" v-if="detail.isLike != 1" />
            <img class="menu-icon" src="@/static/love1.png" v-if="detail.isLike == 1" />
            {{ detail.isLike == 1 ? '取消喜欢' : '喜欢' }}
          </div>
          <div class="item_btn" @click="menuType(3)">
            <img class="menu-icon" style="width: 13px;" src="@/static/shoucang.png" v-if="detail.isCollect != 1" />
            <img class="menu-icon" style="width: 13px;" src="@/static/shoucang1.png" v-if="detail.isCollect == 1" />
