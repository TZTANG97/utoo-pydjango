<template>
  <div class="container">
    <div class="operation-panel">
      <img v-if="login_way" @click="changeLoginWay(false)" class="qrcode-login" src="@/static/qrcode.png" alt="">
      <img v-else @click="changeLoginWay(true)" class="account-login" src="@/static/form-login.png" alt="">
...
<script>
import {getNoteCodeApi, regApi} from '@/api/user'
import {getQrcodeApi, getQrcodeStatusApi} from "@/api/index";
