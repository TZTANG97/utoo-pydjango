...
import { getSwiperListApi } from "@/api/index";
...
<!--          </div>-->
      ...
      >
        <div class="footer">
          <div class="contact-way">
            <img src="@/static/all_name.png" alt="" />
            <div class="address">
              <a>版权信息</a>
              <span>|</span>
              <a>隐私政策</a>
        ...
        <div class="company-info">
          <div class="item-list">
            ...
            <div class="info-item">
              <img src="@/static/post_code.png" alt="" />
              <span>邮编：200000</span>
            </div>
            <div class="info-item">
          ...
          <div class="qrcode-list">
            <div class="qrcode">
              <img src="@/static/gzh.jpg" alt="官方公众号" />
              <div class="label">
            ...
            <div class="qrcode">
              <img src="@/static/xcx.jpg" alt="官方小程序" />
              <div class="label">
                <img src="@/static/xcx_icon.png" alt="" />
                <span>扫码下单</span>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div style="width: 630px;display: flex;justify-content: space-between">
        <img width="300" src="@/static/kefuQRcode.png" alt="" />
        <img width="300" src="@/static/kefuQRcode2.png" alt="" />
      </div>
    </el-dialog>
    ...
    <div class="fixedBox">
      <div @click="systemFn">
        <img width="30px" height="30px" src="@/static/xiaoxi.png" alt="" /><span
          >系统消息</span
        >
      </div>
      <div @click="onlineService">
        <img width="30px" height="30px" src="@/static/kefu.png" alt="" /><span
          >在线客服</span
        >
      </div>
      <div @click="feedbackFn">
        <img width="30px" height="30px" src="@/static/yijian.png" alt="" /><span
          >意见反馈</span
        >
      </div>
