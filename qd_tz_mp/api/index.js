...
export function fetchCateListApi(id) {
	return r({
		url: '/wx/selFirAndSecClassListTuZhe.ajax',
...
// 内部账号绑定微信（途哲小程序，对应后端 weixin.appid_tz）
export function bindWxAccountApi(data) {
	return r({
		url: '/wx/bindaccountTZ.ajax',
		data,
	})
}
