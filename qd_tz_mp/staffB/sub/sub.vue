...
<!-- 			<view class="form-item">
			...
			<view class="form-item">
				...
				<view class="control">
					<switch color="#3C8BDB" @change="swichChange"
			...
			<view class="form-item">
				...
				<view class="control">
					<switch color="#3C8BDB" @change="cloud_video = !cloud_video"
						style="transform:scale(0.6);margin-left: -25rpx;" />
				</view>
			</view>
			...
			<view class="form-item">
				...
				<view class="control">
					<switch color="#3C8BDB" @change="is_arrive = !is_arrive"
									style="transform:scale(0.6);margin-left: -25rpx;" />
				</view>
			</view>
			...
			<view class="form-item">
				...
				<view class="control">
					<switch color="#3C8BDB" @change="is_on = !is_on"
									style="transform:scale(0.6);margin-left: -25rpx;" />
				</view>
			</view>
