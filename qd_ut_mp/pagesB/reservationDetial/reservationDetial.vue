	...
	<view class="container">
		<view class="group">
				...
				<view class="group-content">
					<view class="text-content">
						<u-switch :disabled="detail.status != 0 && detail.status != 1" @change="reversoSwitch"
							v-model="reverso_context" active-color="#E96302" size="28">
						</u-switch>
					</view>
				</view>
			</view>
			...
			<u-calendar btn-type="warning" @change="confirmDate" max-date="2222-01-01"
				active-bg-color="#E96302 !important" v-model="showCalendar" mode="date"></u-calendar>
