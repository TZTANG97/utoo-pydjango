...
$jobs = @(
    @{ Name = "identity"; Script = "start-identity.ps1"; Port = 18110 },
...
Write-Host "Login (admin/pc/wx password) -> qd_svc_identity :18110." -ForegroundColor DarkGray
Write-Host ""
